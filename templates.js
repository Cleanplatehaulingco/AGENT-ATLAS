...
var mainForm = '<div class="page-break">'
  ...
  +'</div></div>'
  +'<div class="section"><div class="section-header"><span class="sec-num">05</span> Service Invoice</div><div class="section-body">'
  +'<table class="form-table"><thead><tr><th>#</th><th>Service / Item Description</th><th>Qty</th><th>Unit Price</th><th>Total</th></tr></thead><tbody>'
  +'<tr><td>1</td><td><div class="editable" data-placeholder="Monthly service visit"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr><td>2</td><td><div class="editable" data-placeholder="Chemicals supplied"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr><td>3</td><td><div class="editable" data-placeholder="Additional services"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr><td>4</td><td><div class="editable" data-placeholder="Equipment / parts"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr class="total-row"><td colspan="4" style="text-align:right;padding-right:14px">Service Total</td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr class="grand-total-row"><td colspan="4" style="text-align:right;padding-right:14px">INVOICE TOTAL</td><td><div class="editable" data-placeholder="$0.00" style="color:#fff"></div></td></tr>'
  +'</tbody></table>'
  +'<div class="field-grid cols-3" style="margin-top:12px"><div class="field"><label>Payment Method</label><div class="editable" data-placeholder="Cash / Card / Check / Zelle"></div></div><div class="field"><label>Payment Status</label><div class="editable" data-placeholder="Paid / Invoiced / Pending"></div></div><div class="field"><label>Next Service Date</label><div class="editable" data-placeholder="MM/DD/YYYY"></div></div></div>'
  +'</div></div>'
...
var mainForm = '<div class="page-break">'
  ...
  +'</div></div>'
  +'<div class="section"><div class="section-header"><span class="sec-num">06</span> Service Invoice</div><div class="section-body">'
  +'<table class="form-table"><thead><tr><th>#</th><th>Service / Item Description</th><th>Qty</th><th>Unit Price</th><th>Total</th></tr></thead><tbody>'
  +'<tr><td>1</td><td><div class="editable" data-placeholder="Tank pump-out service"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr><td>2</td><td><div class="editable" data-placeholder="Effluent filter cleaning"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr><td>3</td><td><div class="editable" data-placeholder="Riser / lid access fee"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr><td>4</td><td><div class="editable" data-placeholder="Additional service or parts"></div></td><td><div class="editable" data-placeholder="1"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr class="total-row"><td colspan="4" style="text-align:right;padding-right:14px">Service Total</td><td><div class="editable" data-placeholder="$0.00"></div></td></tr>'
  +'<tr class="grand-total-row"><td colspan="4" style="text-align:right;padding-right:14px">INVOICE TOTAL</td><td><div class="editable" data-placeholder="$0.00" style="color:#fff"></div></td></tr>'
  +'</tbody></table>'
  +'<div class="field-grid cols-3" style="margin-top:12px"><div class="field"><label>Payment Method</label><div class="editable" data-placeholder="Cash / Card / Check"></div></div><div class="field"><label>Payment Status</label><div class="editable" data-placeholder="Paid / Invoiced / Pending"></div></div><div class="field"><label>Next Recommended Service</label><div class="editable" data-placeholder="MM/DD/YYYY"></div></div></div>'
  +'</div></div>'
